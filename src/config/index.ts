...
export function getTokenForProvider(
  ...
  switch (provider) {
    case ModelProviderName.OPENAI:
      ...
      if (!token) {
        console.warn(
          '[WARN] OPENAI_API_KEY not set. Agent will boot but model inference will fail.\n' +
          'Set OPENAI_API_KEY in .env or character secrets to enable AI responses.'
        );
      }
      return token;
    ...
    default:
      console.warn(`[WARN] Unknown model provider: ${provider}. Using OPENAI.`);
